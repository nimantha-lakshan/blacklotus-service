...
import com.blacklotus.service.services.interfaces.IInvoiceRestService;
...
@Service
@Slf4j
public class InvoiceRestService extends AbstractRestService implements IInvoiceRestService<InvoiceDTO, String> {
